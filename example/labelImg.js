(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ShapeRegister = /** @class */ (function () {
        ...
        ShapeRegister.prototype.is = function (name) {
    ...
    var Platform = /** @class */ (function (_super) {
        ...
        Platform.prototype.isRegister = function (name) {
        ...
        Platform.prototype.guideLine = function (status) {
            this.isGuideLine = lodash_1.default.isUndefined(status) ? !this.isGuideLine : !!status;
            this.render();
        };
        Platform.prototype.tagShow = function (status) {
            this.isTagShow = lodash_1.default.isUndefined(status) ? !this.isTagShow : !!status;
            this.render();
        };
