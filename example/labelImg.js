    ...
    ***************************************************************************** */
    ...
    var Shape = /** @class */ (function (_super) {
        ...
        function Shape(options) {
            ...
            _this.tagNode = function () { return tagNode; };
            _this.tagBody = function () { return tagBody; };
            ...
            tagBodyStyle(_this.tagBody(), _this.getStyle().dotColor);
    ...
    exports.Shape = Shape;
    function tagBodyStyle(tagBody, bgColor) {
        element.css(tagBody, {
            background: bgColor,
            position: "absolute",
            bottom: 5 + "px",
    ...
    var EventHook = /** @class */ (function () {
        function EventHook() {
            var eventMap = {};
            this.getEvents = function (name) {
                return eventMap[name];
            };
            this.createEvent = function (name, _a) {
        ...
        EventHook.prototype.emit = function (name, data) {
            var fns = this.getEvents(name);
            if (!fns)
                return;
        ...
        EventHook.prototype.on = function (name, cb) {
            ...
            return function () {
                var events = _this.getEvents(name);
        ...
        function Platform(container, LabelImgOptions) {
            ...
            _this._init = function () {
                ...
                var _initImageEvent = function () {
                    ...
                    var Image = _this.Image;
                    Image.on("mousedown", lv, function (e) {
                    ...
                    Image.on("mousemove", lv, function (e) {
                        ...
                        if (cache) {
                            if (_this.drawing.type === Shape_1.ShapeType.Polygon) {
                                ...
                                if (isClose) {
                                    ...
                                    _this.cache = null;
                                    _this.eventHook.emit("create", shape);
                                    if (!_this.continuity) {
                                        _this.labelOff();
                                    }
                                }
                ...
                var _initShapeEvent = function () {
                    ...
                    var select = function (shape) {
                        ...
                        _this.eventHook.emit("select", shape);
                        _this.render();
                    };
                    _this.on("mousedown", lv, function (e) {
            ...
            _this.label = function (rid, continuity) {
                ...
                if ((_this.drawing && drawing && rid !== _this.drawing.id) || (!_this.drawing && drawing)) {
                    ...
                    _this.eventHook.emit("labelType");
                }
            ...
            _this.cursor = lodash_1.default.throttle(function (cursor$1) {
                _this.canvas.style.cursor = cursor.displayCursor(cursor$1);
            }, 100);
            // 渲染相关
