(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var lodash_es_1 = /*@__PURE__*/getAugmentedNamespace(lodash$1);
    ...
    var EventReceiver = /** @class */ (function () {
        ...
        EventReceiver.prototype.on = function (type, level, handler) {
            var callback = lodash_es_1.isFunction(level) ? level : handler;
            var lv = lodash_es_1.isFunction(level) ? "mid" : level;
            var kType = type + "." + lv;
            var antEvent = {
                lv: lv,
                type: type,
    ...
    var IDGenerator = /** @class */ (function () {
        ...
        IDGenerator.prototype.getID = function () {
            var id = lodash_es_1.padStart(String(this.count), this.len, "0");
            this.count++;
            return id;
        };
        return IDGenerator;
    ...
    var styles = function (ele, attrs) {
        lodash_es_1.merge(ele.style, attrs);
    };
    var css = function (ele, name, attr) {
        if (lodash_es_1.isString(name)) {
            if (attr) {
                style(ele, name, attr);
            }
            else {
        ...
        else if (lodash_es_1.isObject(name)) {
            styles(ele, name);
        }
    };
    exports.css = css;
    ...
    var Popover = /** @class */ (function () {
        ...
        Popover.prototype.render = function () {
            ...
            if (lodash_es_1.isString(this.content)) {
    ...
    var Shape = /** @class */ (function (_super) {
        ...
        function Shape(options) {
            ...
            _this.addPoint = lodash_es_1.throttle(function (point) {
            ...
            _this.style = lodash_es_1.merge({}, defaultStyle, style);
            _this.closed = closed;
        ...
        Shape.prototype.tagShow = function (status) {
            this.showTag = lodash_es_1.isUndefined(status) ? !this.showTag : !!status;
            this.tagger.css({
                bgColor: this.getStyle().dotColor
            });
        };
    ...
    var Platform = /** @class */ (function (_super) {
        ...
        function Platform(container, LabelImgOptions) {
            ...
            _this.setOptions = function (options) {
                _this._options = lodash_es_1.merge(_this._options, options);
                _this.render();
            };
            ...
            _this.label = function (rid, continuity) {
                ...
                if (!lodash_es_1.isUndefined(continuity)) {
            ...
            _this.setGuideLine = function (status) {
                _this.setOptions({
                    guideLine: lodash_es_1.isUndefined(status) ? !_this.options().guideLine : !!status
                });
                _this.render();
            };
            /**
            ...
            _this.setTagShow = function (status) {
                _this.setOptions({
                    tagShow: lodash_es_1.isUndefined(status) ? !_this.isTagShow : !!status
                });
                _this.render();
            };
            /**
             ...
             */
            _this.cursor = lodash_es_1.throttle(function (cursor$1) {
                _this.canvas.cursor(cursor.displayCursor(cursor$1));
            }, 100);
            _this.scale = function (direction, point) {
                if (lodash_es_1.isUndefined(direction)) {
                    return _this._scale;
                }
            ...
            _this.render = lodash_es_1.throttle(function () {
                _this.forceRender();
            }, 17);
